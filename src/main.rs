...
pub fn load_game_data(game_cfg: GameConfig, dock_state: Arc<Mutex<DockState<window::Tab>>>) {
    Builder::new()
        ...
        .spawn(move || {
            ...
            // I'm going to be honest I'm not a fan of this method, however with how complex these games are we need to save performance (by not recreating tabs) as much as possible
